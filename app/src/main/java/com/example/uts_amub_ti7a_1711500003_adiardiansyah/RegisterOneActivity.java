    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        next.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent gotonexregister = new Intent(com.example.uts_amub_ti7a_1711500003_adiardiansyah.RegisterOneActivity.this, com.example.uts_amub_ti7a_1711500003_adiardiansyah.RegisterTwoActivity.class);
